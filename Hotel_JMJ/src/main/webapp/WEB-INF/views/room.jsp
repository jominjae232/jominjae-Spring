            ...
            <div class="location_area customer">
                <div class="box_inner">
                    ...
                    <table border="1">
                        ...
                        <th>사용 가능 인원</th>
                        <tr><!-- 첫번째 줄 -->
                            <td><button type="submit" class="Room_name1">백두산</button></td>
                            <td>Suite Room</td>
                            <td>4명</td>
                        </tr><!-- // 첫번째 줄 -->
                        <tr><!-- 두번째 줄 -->
                            <td><button type="submit" class="Room_name2">한라산</button></td>
                            <td>Family Room</td>
                            <td>6명</td>
                        </tr><!-- // 두번째 줄 -->
                        <tr><!-- 세번째 줄 -->
                            <td><button type="submit" class="Room_name3">태조산</button></td>
                            <td>Double Room</td>
                            <td>4명</td>
                        </tr><!-- // 세번째 줄 -->
                        <tr><!-- 네번째 줄 -->
                            <td><button type="submit" class="Room_name3">흑성산</button></td>
                            <td>Single Room</td>
                            <td>2명</td>
                        </tr><!-- // 네번째 줄 -->
                        </table>
